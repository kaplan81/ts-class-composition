...
(function (g, y) {
  ...
  function ca(b) {
    return this instanceof ca ? ((this.v = b), this) : new ca(b);
  }
  function ae(b, a, c) {
    function d(a) {
      k[a] &&
      ...
      c.subscribe(
        m(
          ...
          function (c) {
            ...
            if (v)
              try {
                for (var ea = F(v), V = ea.next(); !V.done; V = ea.next())
                  (u = V.value), M(e, u), d.next(u);
              } catch (X) {
                g = { error: X };
              } finally {
                try {
                  V && !V.done && (p = ea.return) && p.call(ea);
                } finally {
                  if (g) throw g.error;
                }
              }
      ...
      a.subscribe(
        m(
          ...
          function () {
            d
              ? (c.next(e), c.complete())
              : c.error(f ? new ld('No matching values') : new aa());
          }
        )
      );
    });
  ...
  function Le(b, a) {
    return Me(ba({ method: 'GET', url: b, headers: a }));
  }
  function Ne(b) {
    return new r(function (a) {
      var c,
      ...
      u.addEventListener(Nd, function (c) {
        ...
        if (400 > e) {
          ...
          a.next(b);
          a.complete();
        } else null === (d = null === r || void 0 === r ? void 0 : r.error) || void 0 === d ? void 0 : d.call(r, c), x(e);
      });
      e = q.user;
      d = q.method;
      h = q.async;
  ...
  var Pa = (function () {
    ...
    af = Object.freeze({
      ...
      race: function () {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        return tb.apply(void 0, x([], w(Z(b))));
      },
      raceWith: tb,
      reduce: fa,
      repeat: bd,
